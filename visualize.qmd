...
![ggplot2의 계층 개념](pics/visualize/ggplot2_layers.png)
...
![3차원 그래프의 예](pics/visualize/3D_GRAPH.png){width=70%}
...
![넓은 데이터를 길쭉하게](pics/visualize/pivot_longer.png)
...
![시각화를 위한 워크플로우](pics/visualize/workflow.png)
...
![시각화 계획을 위한 워크플로우](pics/visualize/schematic.png)
